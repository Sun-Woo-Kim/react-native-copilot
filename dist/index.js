...
// src/components/default-ui/Tooltip.tsx
init_style();
var Tooltip = ({ labels, tooltipTextColor }) => {
  ...
  return /* @__PURE__ */ import_react2.default.createElement(import_react_native3.View, null, /* @__PURE__ */ import_react2.default.createElement(import_react_native3.View, { style: styles.tooltipContainer }, /* @__PURE__ */ import_react2.default.createElement(
    ...
    currentStep == null ? void 0 : currentStep.text
...
var CopilotProvider = (_a) => {
        ...
        setTimeout(() => {
          ...
          wrapper.measure((fx, fy, width, height, px, py) => {
            ...
            if (elementHeight > screenHeight * 0.7) {
              ...
              const wouldBeBottomPosition = elementTopInScrollView - targetScrollY + elementHeight;
              ...
              setTimeout(() => {
                if (wrapper && scrollView && retryCount < maxRetries) {
                  wrapper.measureInWindow((x, y, windowWidth, windowHeight) => {
                    ...
                    const isWellPositioned = y >= minVisibleTop && y <= minVisibleBottom;
                    const elementBottom = y + elementHeight;
                    const isBottomVisible = elementBottom <= screenHeight;
                    if (!isWellPositioned || elementHeight < screenHeight * 0.7 && !isBottomVisible) {
                      retryCount++;
                      ...
                      if (retryCount > 2) {
                        const aggressiveScrollY = elementTopInScrollView - minVisibleTop;
                        scrollView.scrollTo({
  ...
  return /* @__PURE__ */ import_react8.default.createElement(CopilotContext.Provider, { value }, /* @__PURE__ */ import_react8.default.createElement(import_react8.default.Fragment, null, /* @__PURE__ */ import_react8.default.createElement(CopilotModal, __spreadValues({ ref: modal }, rest)), children));
};
var useCopilot = () => {
